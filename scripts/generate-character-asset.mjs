...
const SLOTS = {
  ...
  // 약한 비 × 온도 zone 변형 — 우산을 들고 있되 의상은 해당 zone 추천과 일치
  'male-rain-light-mild-v1':   { gender: 'male',   outfit: 'Plain ivory crewneck SWEATSHIRT (loose cotton pullover, rounded ribbed neckline — a classic 맨투맨), light beige cotton chinos, white sneakers, holding a navy OPEN umbrella tilted slightly above the head with one hand, the other arm relaxed. Clearly NOT a trench coat, NOT a long coat. Sweatshirt is the outermost layer.' },
  'female-rain-light-mild-v1': { gender: 'female', outfit: 'Soft cream crewneck SWEATSHIRT (loose cotton pullover, rounded ribbed neckline — a classic 맨투맨), light blue ankle jeans, white sneakers, holding a pastel-yellow OPEN umbrella tilted slightly above the head with one hand, the other arm relaxed. Clearly NOT a trench coat, NOT a long coat. Sweatshirt is the outermost layer.' },
  'male-rain-light-cool-v1':   { gender: 'male',   outfit: 'Heather grey crewneck SWEATSHIRT layered UNDER an OPEN hip-length light denim jacket (both panels open showing the grey sweatshirt down the center), light beige slacks, white sneakers, holding a navy OPEN umbrella tilted slightly above the head with one hand. Clearly NOT a trench coat. Hip-length jacket, NOT a long coat.' },
  'female-rain-light-cool-v1': { gender: 'female', outfit: 'Soft cream crewneck SWEATSHIRT layered UNDER an OPEN hip-length light denim jacket (both panels open showing the cream sweatshirt down the center), light blue ankle pants, off-white sneakers, holding a pastel-yellow OPEN umbrella tilted slightly above the head with one hand. Clearly NOT a trench coat. Hip-length jacket, NOT a long coat.' },
  'male-rain-light-cold-v1':   { gender: 'male',   outfit: 'Hip-length quilted light puffer jacket (matte navy, horizontal stitched channels, full zip closed, hem at the hip — clearly NOT a long coat, NOT a trench, NOT a wool overcoat) over a cream crewneck knit visible at the collar, charcoal wool pants, brown leather lace-up boots, holding a navy OPEN umbrella tilted slightly above the head with one hand.' },
  'female-rain-light-cold-v1': { gender: 'female', outfit: 'Hip-length quilted light puffer jacket (matte warm beige or soft camel, horizontal stitched channels, full zip closed, hem at the hip — clearly NOT a long coat, NOT a trench, NOT a wool overcoat) over a cream knit crewneck visible at the collar, grey wide-leg trousers, brown ankle boots, holding a pastel-yellow OPEN umbrella tilted slightly above the head with one hand.' },
  // 여름 비 (warm/hot 구간 약한 비) — 트렌치 대신 얇은 셔츠/티셔츠 + 우산
  'male-rain-light-warm-v1':   { gender: 'male',   outfit: 'Plain ivory thin LONG-SLEEVE button-up cotton shirt with cuffs fully buttoned at the wrists, slim light-blue jeans, white sneakers, holding a navy OPEN umbrella tilted slightly above the head with one hand. Clearly NOT a trench coat, NOT a long coat.' },
  'female-rain-light-warm-v1': { gender: 'female', outfit: 'Plain ivory thin LONG-SLEEVE button-up cotton blouse with cuffs fully buttoned at the wrists, soft pink ankle pants, white sneakers, holding a pastel-yellow OPEN umbrella tilted slightly above the head with one hand. Clearly NOT a trench coat, NOT a long coat.' },
  'male-rain-light-hot-v1':    { gender: 'male',   outfit: 'Light pastel-blue SHORT-SLEEVE t-shirt, beige knee-length shorts, white slip-on sneakers, holding a navy OPEN umbrella tilted slightly above the head with one hand. Clearly summer outfit, NOT a trench coat, NOT a long coat. T-shirt sleeves clearly above the elbow.' },
  'female-rain-light-hot-v1':  { gender: 'female', outfit: 'Soft coral SHORT-SLEEVE t-shirt, mint-green knee-length shorts, white sneakers, holding a pastel-yellow OPEN umbrella tilted slightly above the head with one hand. Clearly summer outfit, NOT a trench coat, NOT a long coat. T-shirt sleeves clearly above the elbow.' },
}
