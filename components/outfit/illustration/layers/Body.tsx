  ...
  return (
    <g>
      ...
      {isF ? (
        ...
        <path
          d="M83 24 Q82 7 100 5 Q118 7 118 52 Q111 34 100 27 Q89 34 82 52 Q82 7 83 24Z"
          fill="#292524"
        />
      ) : (
        /* Male: 얼굴 타원(rx=11)에 맞춰 좌우 안쪽으로 붙인 단발 */
        <path
          d="M89 24 Q88 7 100 5 Q112 7 111 24 Q108 16 100 15 Q92 16 89 24Z"
          fill="#1C1917"
        />
      )}
