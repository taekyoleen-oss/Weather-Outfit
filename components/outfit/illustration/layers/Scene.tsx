...
function sceneDecoration(illustKey: HeroIllustKey) {
  switch (illustKey) {
    case 'summer-light':
    case 'summer-sport':
      // 기존 태양 도형 제거 (요청사항)
    ...
    case 'beach-look':
      return (
        <g>
          {/* 기존 태양 도형 제거, 파도만 유지 */}
          <path
            d="M10 228 Q40 218 70 228 Q100 238 130 228 Q160 218 190 228"
            stroke="#38BDF8"
            strokeWidth="3"
            fill="none"
            opacity="0.5"
          ...
          />
          <path
            d="M5 235 Q35 225 65 235 Q95 245 125 235 Q155 225 195 235"
            stroke="#7DD3FC"
            strokeWidth="2"
            fill="none"
            opacity="0.35"
...
interface SceneProps {
  ...
  sunGradPrefix?: string
}

export function Scene({ illustKey }: SceneProps) {
  return sceneDecoration(illustKey)
}
