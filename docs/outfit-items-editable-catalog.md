...
| id | 변경 전 | 변경 후 |
|----|---------|---------|
| `top-tshirt` | 밝은색 기능성 반팔 또는 얇은 긴팔 | 반팔 또는 얇은 긴팔 |
| `top-blouse` | 반팔 또는 얇은 긴팔 / UV 가디건 | 반팔 또는 얇은 긴팔|
| `top-shirt-light` | 얇은 반팔·긴팔 또는 카라 셔츠 | 얇은 반팔·긴팔 / 셔츠 |
| `top-blouse-warm` | 얇은 반팔·긴팔 또는 블라우스 | 반팔·긴팔 / 블라우스 |
| `top-longsleeve` | 긴팔 티셔츠 | 긴팔 티셔츠 |
| `top-longsleeve-f` | 긴팔 티 / 얇은 니트 | 긴팔 티 / 얇은 니트 |
| `top-shirt` | 니트·맨투맨 또는 두꺼운 긴팔 *(cool 구간 남성)* | 스웨터 / 두꺼운 긴팔 *(cool 구간 남성)* |
| `top-shirt` | 두꺼운 긴팔 셔츠 *(cold/freezing 구간 남성, 동일 id)* | 두꺼운 긴팔 셔츠 *(cold/freezing 구간 남성, 동일 id)* |
| `top-knit` | 니트·맨투맨 / 두꺼운 긴팔 *(cool 구간 여성)* | 스웨터 / 두꺼운 긴팔 *(cool 구간 여성)* |
| `top-knit` | 터틀넥 니트 / 두꺼운 긴팔 *(cold/freezing 구간 여성, 동일 id)* | 터틀넥 니트 / 두꺼운 긴팔 *(cold/freezing 구간 여성, 동일 id)* |
| `corr-uv-sleeves` | 긴팔 겉옷 또는 UV 팔토시 | 긴팔 겉옷 |
...
| `mid-sweater-f` | 두꺼운 니트 / 울 가디건 | 두꺼운 니트 |
| `mc-golf-windvest` | 골프 윈드 베스트 | 골프 윈드 베스트 |
| `mc-hiking-midlayer` | 얇은 플리스 / 경량 다운 (배낭에) | 얇은 플리스 / 경량 다운 |
...
| `outer-coat` | 경량 패딩 / 코트 / 플리스 겉옷 | 경량 패딩 / 코트 / 플리스 |
| `outer-coat-f` | 경량 패딩 / 코트 / 플리스 겉옷 | 경량 패딩 / 코트 / 플리스 |
...
| `outer-ski-jacket` | 스키 재킷 (방수·방풍) | 스키 재킷 |
| `mc-river-windbreaker` | 얇은 바람막이 (강바람 대비) | 얇은 바람막이 |
| `mc-river-windbreaker-mild` | 방풍 점퍼 (강바람 대비) | 방풍 점퍼 |
| `mc-hiking-windbreaker` | 경량 바람막이 (배낭에 보관) | 경량 바람막이 |
| `mc-beach-coverup` | 비치 커버업 / 파레오 | 비치 커버업 / 파레오 |
| `corr-wind-fives` | 얇은 바람막이 (방풍) | 얇은 바람막이 |
...
| id | 변경 전 | 변경 후 |
|----|---------|---------|
| `bottom-skirt-mini` | 통기성 팬츠·큐롯 / 린넨 쇼츠 | 통기성 팬츠·큐롯 / 여름 하의 |
| `bottom-dress` | 원피스 (선택) | 원피스 (선택) |
| `bottom-shorts-m` | 통기성 반바지 / 경량 팬츠 | 반바지 / 경량 팬츠 |
| `bottom-linen-pants-f` | 통기성 긴바지·레깅스 / 반바지 | 통기성 긴바지 / 반바지 |
| `bottom-midi-skirt` | 미디스커트 (선택) | 미디스커트 (선택) |
| `bottom-wide-pants` | 와이드 팬츠 / 청바지 | 긴바지 / 청바지 |
| `bottom-midi-skirt-mild` | 미디스커트 + 스타킹 (선택) | 미디스커트 + 스타킹 (선택) |
| `bottom-pants` | 면 팬츠 / 청바지 | 면바지 / 청바지 |
| `bottom-slacks-f` | 슬랙스 / 두꺼운 청바지 | 면바지 / 두꺼운 청바지 |
| `bottom-long-skirt` | 롱스커트 + 두꺼운 타이츠 (선택) | 롱스커트 + 두꺼운 타이츠 (선택) |
| `bottom-slacks-m` | 청바지 / 슬랙스 | 청바지 / 면바지 |
| `bottom-warm-pants-f` | 기모 바지 / 두꺼운 슬랙스 | 두꺼운 바지 |
| `bottom-warm-pants` | 두꺼운 팬츠 / 기모 바지 | 두꺼운 바지 |
| `top-golf-skirt` | 골프 스커트 / 팬츠 | 골프 스커트 / 바지 |
| `bottom-ski-pants` | 스키 팬츠 | 스키 바지 |
...
| `foot-boots-f` | 방한 부츠 / 앵클 부츠 | 방한 부츠 |
| `foot-loafer` | 로퍼 / 운동화 | 로퍼 / 운동화 |
| `rain-shoes` | 미끄럼 적은 방수 신발 | 방수 신발 |
...
|----|---------|---------|
| `acc-hot-hat` | 모자 | 모자 |
| `acc-hot-sunglasses` | UV 차단 선글라스 | 선글라스 |
| `mc-beach-uvhat` | 모자 | 모자 |
| `mc-beach-suncream` | SPF50+ PA++++ 선크림 | 선크림 |
| `mc-golf-armsleeve` | UV 차단 팔토시 | 팔토시 |
...
| `acc-hat-sun-f` | 모자 | 모자 |
| `acc-hat-sun` | 모자 | 모자 |
| `acc-sunglasses-warm` | UV 차단 선글라스 | 선글라스 |
| `acc-headband` | 헤드밴드 / 스포츠 모자 | 스포츠 모자 |
| `corr-uv-widehat` | 모자 | 모자 |
| `corr-cold-wind-scarf` | 목도리 | 목도리 |
| `corr-cold-wind-gloves` | 장갑 | 장갑 |
| `corr-cold-wind-beanie` | 비니 / 니트 모자 | 비니 / 니트 모자 |
| `corr-freeze-duration-ear` | 귀마개 / 이어워머 | 귀마개 |
| `acc-suncream` | SPF50+ 자외선 차단제 | 선크림 |
...
| id | 변경 전 | 변경 후 |
|----|---------|---------|
| `rain-coat` | 비옷 / 레인자켓 (낙뢰 시 우산 대신) | 비옷 (낙뢰 시) |
...
| id | 변경 전 | 변경 후 |
|----|---------|---------|
| `mask-dust` | `KF80` / `KF94` 보건용 마스크 *(코드에서 등급에 따라 문자열 조합)* | 보건용 마스크 *(코드에서 등급에 따라 문자열 조합)* |

> **참고:** 마스크 `name`은 `recommender.ts`에서 `보건용 마스크`로 고정이며, KF80/KF94 구분은 `condition` 문자열에 표시됩니다.
